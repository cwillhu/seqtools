...
class Migration(SchemaMigration):
    ...
    def forwards(self, orm):
        ...
        # Changing field 'SeqRun.specs'
        db.alter_column(u'seqstats_seqrun', 'specs', self.gf('django.db.models.fields.TextField')(default=''))

    def backwards(self, orm):

        # Changing field 'SeqRun.specs'
        db.alter_column(u'seqstats_seqrun', 'specs', self.gf('seqstats.customFields.JSONField')(null=True))
